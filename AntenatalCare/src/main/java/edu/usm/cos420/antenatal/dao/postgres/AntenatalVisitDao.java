...
public class AntenatalVisitDao implements IAntenatalVisit {
  ...
  public AntenatalVisitDao(Connection connection) {
    this.connection = connection;
  }

  @Override
  public int add(PregnancyRecord record) throws SQLException {
  ...
  @Override
  public int update(PregnancyRecord record) throws SQLException {
  ...
  @Override
  public PregnancyRecord find(String key) throws SQLException {
  ...
  @Override
  public List<PregnancyRecord> list() throws SQLException {
  ...
  private PregnancyRecord createRecord(ResultSet rs) throws SQLException {
